...
abstract class _AnimeEntity implements AnimeEntity {
  factory _AnimeEntity(
      ...
      @JsonKey(name: AnimeTableColumns.season) final String? season,
      @JsonKey(name: AnimeTableColumns.trailerThumbnail)
