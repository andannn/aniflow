...
UserLengthStaticsDto _$UserLengthStaticsDtoFromJson(Map<String, dynamic> json) {
  return _UserLengthStaticsDto.fromJson(json);
}

/// @nodoc
mixin _$UserLengthStaticsDto {
  @JsonKey(name: 'count')
...
/// @nodoc
abstract class $UserLengthStaticsDtoCopyWith<$Res> {
  factory $UserLengthStaticsDtoCopyWith(UserLengthStaticsDto value,
          $Res Function(UserLengthStaticsDto) then) =
      _$UserLengthStaticsDtoCopyWithImpl<$Res, UserLengthStaticsDto>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UserLengthStaticsDtoCopyWithImpl<$Res,
        $Val extends UserLengthStaticsDto>
    implements $UserLengthStaticsDtoCopyWith<$Res> {
  _$UserLengthStaticsDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UserLengthStaticsDtoImplCopyWith<$Res>
    implements $UserLengthStaticsDtoCopyWith<$Res> {
  factory _$$UserLengthStaticsDtoImplCopyWith(_$UserLengthStaticsDtoImpl value,
          $Res Function(_$UserLengthStaticsDtoImpl) then) =
      __$$UserLengthStaticsDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'count') int? count,
...
/// @nodoc
class __$$UserLengthStaticsDtoImplCopyWithImpl<$Res>
    extends _$UserLengthStaticsDtoCopyWithImpl<$Res, _$UserLengthStaticsDtoImpl>
    implements _$$UserLengthStaticsDtoImplCopyWith<$Res> {
  __$$UserLengthStaticsDtoImplCopyWithImpl(_$UserLengthStaticsDtoImpl _value,
  ...
  $Res call({
    ...
    return _then(_$UserLengthStaticsDtoImpl(
      count: freezed == count
          ? _value.count
          : count // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UserLengthStaticsDtoImpl implements _UserLengthStaticsDto {
  const _$UserLengthStaticsDtoImpl(
  ...
  factory _$UserLengthStaticsDtoImpl.fromJson(Map<String, dynamic> json) =>
      _$$UserLengthStaticsDtoImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UserLengthStaticsDto(count: $count, meanScore: $meanScore, minutesWatched: $minutesWatched, chaptersRead: $chaptersRead, mediaIds: $mediaIds, score: $score)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UserLengthStaticsDtoImpl &&
  ...
  _$$UserLengthStaticsDtoImplCopyWith<_$UserLengthStaticsDtoImpl>
      get copyWith =>
          __$$UserLengthStaticsDtoImplCopyWithImpl<_$UserLengthStaticsDtoImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UserLengthStaticsDtoImplToJson(
      this,
    );
  }
}
...
abstract class _UserLengthStaticsDto implements UserLengthStaticsDto {
  const factory _UserLengthStaticsDto(
      ...
      @JsonKey(name: 'score') final int? score}) = _$UserLengthStaticsDtoImpl;

  factory _UserLengthStaticsDto.fromJson(Map<String, dynamic> json) =
      _$UserLengthStaticsDtoImpl.fromJson;
