...
UserCountryStaticsDto _$UserCountryStaticsDtoFromJson(
    Map<String, dynamic> json) {
  return _UserCountryStaticsDto.fromJson(json);
}

/// @nodoc
mixin _$UserCountryStaticsDto {
  @JsonKey(name: 'count')
...
/// @nodoc
abstract class $UserCountryStaticsDtoCopyWith<$Res> {
  factory $UserCountryStaticsDtoCopyWith(UserCountryStaticsDto value,
          $Res Function(UserCountryStaticsDto) then) =
      _$UserCountryStaticsDtoCopyWithImpl<$Res, UserCountryStaticsDto>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UserCountryStaticsDtoCopyWithImpl<$Res,
        $Val extends UserCountryStaticsDto>
    implements $UserCountryStaticsDtoCopyWith<$Res> {
  _$UserCountryStaticsDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UserCountryStaticsDtoImplCopyWith<$Res>
    implements $UserCountryStaticsDtoCopyWith<$Res> {
  factory _$$UserCountryStaticsDtoImplCopyWith(
          _$UserCountryStaticsDtoImpl value,
          $Res Function(_$UserCountryStaticsDtoImpl) then) =
      __$$UserCountryStaticsDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'count') int? count,
...
/// @nodoc
class __$$UserCountryStaticsDtoImplCopyWithImpl<$Res>
    extends _$UserCountryStaticsDtoCopyWithImpl<$Res,
        _$UserCountryStaticsDtoImpl>
    implements _$$UserCountryStaticsDtoImplCopyWith<$Res> {
  __$$UserCountryStaticsDtoImplCopyWithImpl(_$UserCountryStaticsDtoImpl _value,
  ...
  $Res call({
    ...
    return _then(_$UserCountryStaticsDtoImpl(
      count: freezed == count
          ? _value.count
          : count // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UserCountryStaticsDtoImpl implements _UserCountryStaticsDto {
  const _$UserCountryStaticsDtoImpl(
  ...
  factory _$UserCountryStaticsDtoImpl.fromJson(Map<String, dynamic> json) =>
      _$$UserCountryStaticsDtoImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UserCountryStaticsDto(count: $count, meanScore: $meanScore, minutesWatched: $minutesWatched, chaptersRead: $chaptersRead, mediaIds: $mediaIds, releaseYear: $releaseYear)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UserCountryStaticsDtoImpl &&
  ...
  _$$UserCountryStaticsDtoImplCopyWith<_$UserCountryStaticsDtoImpl>
      get copyWith => __$$UserCountryStaticsDtoImplCopyWithImpl<
          _$UserCountryStaticsDtoImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UserCountryStaticsDtoImplToJson(
      this,
    );
  }
}

abstract class _UserCountryStaticsDto implements UserCountryStaticsDto {
  const factory _UserCountryStaticsDto(
  ...
  factory _UserCountryStaticsDto.fromJson(Map<String, dynamic> json) =
      _$UserCountryStaticsDtoImpl.fromJson;
