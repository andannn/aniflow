...
class _$_MediaDataChangeNotificationDto
  ...
  @override
  String toString() {
    return 'MediaDataChangeNotificationDto(id: $id, type: $type, mediaId: $mediaId, contexts: $contexts, createdAt: $createdAt, reason: $reason, media: $media)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, type, mediaId,
      const DeepCollectionEquality().hash(_contexts), createdAt, reason, media);
