...
UserReleaseYearStaticsDto _$UserReleaseYearStaticsDtoFromJson(
    Map<String, dynamic> json) {
  return _UserReleaseYearStaticsDto.fromJson(json);
}

/// @nodoc
mixin _$UserReleaseYearStaticsDto {
  @JsonKey(name: 'count')
...
/// @nodoc
abstract class $UserReleaseYearStaticsDtoCopyWith<$Res> {
  factory $UserReleaseYearStaticsDtoCopyWith(UserReleaseYearStaticsDto value,
          $Res Function(UserReleaseYearStaticsDto) then) =
      _$UserReleaseYearStaticsDtoCopyWithImpl<$Res, UserReleaseYearStaticsDto>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UserReleaseYearStaticsDtoCopyWithImpl<$Res,
        $Val extends UserReleaseYearStaticsDto>
    implements $UserReleaseYearStaticsDtoCopyWith<$Res> {
  _$UserReleaseYearStaticsDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UserReleaseYearStaticsDtoImplCopyWith<$Res>
    implements $UserReleaseYearStaticsDtoCopyWith<$Res> {
  factory _$$UserReleaseYearStaticsDtoImplCopyWith(
          _$UserReleaseYearStaticsDtoImpl value,
          $Res Function(_$UserReleaseYearStaticsDtoImpl) then) =
      __$$UserReleaseYearStaticsDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'count') int? count,
...
/// @nodoc
class __$$UserReleaseYearStaticsDtoImplCopyWithImpl<$Res>
    extends _$UserReleaseYearStaticsDtoCopyWithImpl<$Res,
        _$UserReleaseYearStaticsDtoImpl>
    implements _$$UserReleaseYearStaticsDtoImplCopyWith<$Res> {
  __$$UserReleaseYearStaticsDtoImplCopyWithImpl(
      _$UserReleaseYearStaticsDtoImpl _value,
  ...
  $Res call({
    ...
    return _then(_$UserReleaseYearStaticsDtoImpl(
      count: freezed == count
          ? _value.count
          : count // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UserReleaseYearStaticsDtoImpl implements _UserReleaseYearStaticsDto {
  const _$UserReleaseYearStaticsDtoImpl(
  ...
  factory _$UserReleaseYearStaticsDtoImpl.fromJson(Map<String, dynamic> json) =>
      _$$UserReleaseYearStaticsDtoImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UserReleaseYearStaticsDto(count: $count, meanScore: $meanScore, minutesWatched: $minutesWatched, chaptersRead: $chaptersRead, mediaIds: $mediaIds, releaseYear: $releaseYear)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UserReleaseYearStaticsDtoImpl &&
  ...
  _$$UserReleaseYearStaticsDtoImplCopyWith<_$UserReleaseYearStaticsDtoImpl>
      get copyWith => __$$UserReleaseYearStaticsDtoImplCopyWithImpl<
          _$UserReleaseYearStaticsDtoImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UserReleaseYearStaticsDtoImplToJson(
      this,
    );
  }
}

abstract class _UserReleaseYearStaticsDto implements UserReleaseYearStaticsDto {
  const factory _UserReleaseYearStaticsDto(
          ...
          @JsonKey(name: 'releaseYear') final int? releaseYear}) =
      _$UserReleaseYearStaticsDtoImpl;

  factory _UserReleaseYearStaticsDto.fromJson(Map<String, dynamic> json) =
      _$UserReleaseYearStaticsDtoImpl.fromJson;
