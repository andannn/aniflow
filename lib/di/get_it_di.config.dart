...
import 'package:aniflow/core/background_task/executors/post_anilist_notification_task_executor.dart'
    as _i43;
import 'package:aniflow/core/background_task/task_manager.dart' as _i30;
import 'package:aniflow/core/common/definitions/activity_filter_type.dart'
    as _i88;
import 'package:aniflow/core/common/definitions/activity_scope_category.dart'
    as _i87;
import 'package:aniflow/core/common/definitions/media_category.dart' as _i65;
import 'package:aniflow/core/common/definitions/media_sort.dart' as _i59;
import 'package:aniflow/core/common/definitions/media_type.dart' as _i41;
import 'package:aniflow/core/common/definitions/staff_language.dart' as _i70;
import 'package:aniflow/core/common/message/message.dart' as _i13;
import 'package:aniflow/core/data/activity_repository.dart' as _i61;
import 'package:aniflow/core/data/auth_repository.dart' as _i29;
import 'package:aniflow/core/data/character_repository.dart' as _i32;
import 'package:aniflow/core/data/favorite_repository.dart' as _i34;
import 'package:aniflow/core/data/hi_animation_repository.dart' as _i10;
import 'package:aniflow/core/data/media_information_repository.dart' as _i36;
import 'package:aniflow/core/data/media_list_repository.dart' as _i37;
import 'package:aniflow/core/data/notification_repository.dart' as _i42;
import 'package:aniflow/core/data/search_repository.dart' as _i48;
...
import 'package:aniflow/core/data/user_statistics_repository.dart' as _i57;
import 'package:aniflow/core/database/aniflow_database.dart' as _i3;
import 'package:aniflow/core/database/dao/activity_dao.dart' as _i24;
import 'package:aniflow/core/database/dao/airing_schedules_dao.dart' as _i25;
...
import 'package:aniflow/core/database/di/database_module.dart' as _i90;
...
import 'package:aniflow/core/firebase/remote_config/remote_config_manager.dart'
    as _i15;
import 'package:aniflow/core/network/ani_list_data_source.dart' as _i26;
import 'package:aniflow/core/network/auth_data_source.dart' as _i28;
import 'package:aniflow/core/network/di/di_network_module.dart' as _i27;
...
import 'package:aniflow/feature/airing_schedule/movie_schedule_time_line/movie_schedule_time_line_bloc.dart'
    as _i39;
import 'package:aniflow/feature/aniflow_home/auth/bloc/auth_bloc.dart' as _i66;
...
import 'package:aniflow/feature/media_list_update_page/bloc/media_list_update_bloc.dart'
    as _i38;
import 'package:aniflow/feature/media_page/bloc/media_page_bloc.dart' as _i64;
...
import 'package:aniflow/feature/notification/bloc/notification_paging_bloc.dart'
    as _i82;
import 'package:aniflow/feature/profile/profile_bloc.dart' as _i44;
...
import 'package:aniflow/feature/profile/sub_media_list/bloc/manga_list_paging_bloc.dart'
    as _i45;
import 'package:aniflow/feature/profile/sub_stats/bloc/stats_bloc.dart' as _i83;
import 'package:aniflow/feature/search/bloc/search_bloc.dart' as _i47;
...
import 'package:aniflow/feature/search/paging/user_search_result_paging_bloc.dart'
    as _i56;
import 'package:aniflow/feature/settings/bloc/settings_bloc.dart' as _i49;
import 'package:aniflow/feature/staff_page/bloc/staff_page_bloc.dart' as _i50;
import 'package:dio/dio.dart' as _i5;
import 'package:firebase_remote_config/firebase_remote_config.dart' as _i8;
import 'package:get_it/get_it.dart' as _i1;
import 'package:injectable/injectable.dart' as _i2;
import 'package:shared_preferences/shared_preferences.dart' as _i16;
import 'package:workmanager/workmanager.dart' as _i23;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    await gh.lazySingletonAsync<_i23.Workmanager>(
      () => dIWorkmanagerModule.workManager,
      preResolve: true,
    );
    gh.factory<_i24.ActivityDao>(
        () => dIDataBaseModule.getActivityDao(gh<_i3.AniflowDatabase>()));
    gh.factory<_i25.AiringSchedulesDao>(() =>
        dIDataBaseModule.getAiringSchedulesDao(gh<_i3.AniflowDatabase>()));
    gh.lazySingleton<_i26.AniListDataSource>(
        () => _i26.AniListDataSource(gh<_i5.Dio>()));
    gh.factory<_i27.AniListTokenHeaderInterceptor>(() =>
        _i27.AniListTokenHeaderInterceptor(gh<_i21.UserDataRepository>()));
    gh.lazySingleton<_i28.AuthDataSource>(
        () => _i28.AuthDataSource(gh<_i5.Dio>()));
    ...
    gh.lazySingleton<_i30.BackgroundTaskManager>(
        () => _i30.BackgroundTaskManager(
              gh<_i29.AuthRepository>(),
              gh<_i23.Workmanager>(),
            ));
    gh.factory<_i31.CharacterPageBloc>(
        () => _i31.CharacterPageBloc(gh<_i21.UserDataRepository>()));
    gh.factory<_i32.CharacterRepository>(() => _i32.CharacterRepository(
          gh<_i4.CharacterDao>(),
          gh<_i26.AniListDataSource>(),
        ));
    gh.factory<_i33.EditProfileBloc>(
        () => _i33.EditProfileBloc(gh<_i29.AuthRepository>()));
    gh.lazySingleton<_i34.FavoriteRepository>(() => _i34.FavoriteRepository(
          gh<_i26.AniListDataSource>(),
          gh<_i19.UserDao>(),
          gh<_i11.MediaDao>(),
          gh<_i17.StaffDao>(),
    ...
    gh.factoryParam<_i35.FavoriteStaffPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i35.FavoriteStaffPagingBloc(
          userId,
          gh<_i34.FavoriteRepository>(),
          gh<_i21.UserDataRepository>(),
          perPageCount,
        ));
    gh.lazySingleton<_i36.MediaInformationRepository>(
        () => _i36.MediaInformationRepository(
              gh<_i26.AniListDataSource>(),
              gh<_i4.CharacterDao>(),
              gh<_i17.StaffDao>(),
              gh<_i18.StudioDao>(),
              gh<_i25.AiringSchedulesDao>(),
              gh<_i11.MediaDao>(),
              gh<_i21.UserDataRepository>(),
            ));
    gh.lazySingleton<_i37.MediaListRepository>(() => _i37.MediaListRepository(
          gh<_i28.AuthDataSource>(),
          gh<_i26.AniListDataSource>(),
          gh<_i12.MediaListDao>(),
          gh<_i19.UserDao>(),
    ...
    gh.factoryParam<_i38.MediaListUpdateBloc, String, dynamic>((
      _mediaId,
      _,
    ) =>
        _i38.MediaListUpdateBloc(
          _mediaId,
          gh<_i37.MediaListRepository>(),
        ));
    gh.factory<_i39.MovieScheduleTimeLineBloc>(
        () => _i39.MovieScheduleTimeLineBloc(
              gh<_i36.MediaInformationRepository>(),
    ...
    gh.lazySingleton<_i42.NotificationRepository>(
        () => _i42.NotificationRepository(
              gh<_i28.AuthDataSource>(),
              gh<_i19.UserDao>(),
              gh<_i11.MediaDao>(),
            ));
    gh.factory<_i43.PostAnilistNotificationExecutor>(
        () => _i43.PostAnilistNotificationExecutor(
              gh<_i42.NotificationRepository>(),
              gh<_i29.AuthRepository>(),
              gh<_i21.UserDataRepository>(),
            ));
    gh.factoryParam<_i44.ProfileBloc, String?, dynamic>((
      _userId,
      _,
    ) =>
        _i44.ProfileBloc(
    ...
    gh.factoryParam<_i45.ReadingMangaListPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i45.ReadingMangaListPagingBloc(
          userId,
          gh<_i37.MediaListRepository>(),
          perPageCount,
        ));
    gh.factory<_i46.RecentMoviesBloc>(
        () => _i46.RecentMoviesBloc(gh<_i36.MediaInformationRepository>()));
    gh.factory<_i47.SearchBloc>(
        () => _i47.SearchBloc(gh<_i21.UserDataRepository>()));
    gh.lazySingleton<_i48.SearchRepository>(() => _i48.SearchRepository(
          gh<_i26.AniListDataSource>(),
          gh<_i11.MediaDao>(),
          gh<_i4.CharacterDao>(),
          gh<_i17.StaffDao>(),
    ...
    gh.factoryParam<_i50.StaffPageBloc, String, dynamic>((
      animeId,
      _,
    ) =>
        _i50.StaffPageBloc(
    ...
    gh.factoryParam<_i51.StaffSearchResultPagingBloc, String, dynamic>((
      _searchString,
      _,
    ) =>
        _i51.StaffSearchResultPagingBloc(
          _searchString,
          gh<_i48.SearchRepository>(),
        ));
    gh.factoryParam<_i52.StudioContentsPagingBloc, String, dynamic>((
      studioId,
      _,
    ) =>
        _i52.StudioContentsPagingBloc(
          studioId,
          gh<_i36.MediaInformationRepository>(),
        ));
    gh.factoryParam<_i53.StudioSearchResultPagingBloc, String, dynamic>((
      _searchString,
      _,
    ) =>
        _i53.StudioSearchResultPagingBloc(
          _searchString,
          gh<_i48.SearchRepository>(),
        ));
    gh.factory<_i54.TodayAiringScheduleBloc>(() =>
        _i54.TodayAiringScheduleBloc(gh<_i36.MediaInformationRepository>()));
    gh.factory<_i55.TrackBloc>(() => _i55.TrackBloc(
          gh<_i37.MediaListRepository>(),
          gh<_i29.AuthRepository>(),
          gh<_i21.UserDataRepository>(),
          gh<_i13.MessageRepository>(),
        ));
    gh.factoryParam<_i56.UserSearchResultPagingBloc, String, dynamic>((
      _searchString,
      _,
    ) =>
        _i56.UserSearchResultPagingBloc(
          _searchString,
          gh<_i48.SearchRepository>(),
        ));
    gh.lazySingleton<_i57.UserStatisticsRepository>(
        () => _i57.UserStatisticsRepository(
              gh<_i11.MediaDao>(),
              gh<_i26.AniListDataSource>(),
            ));
    gh.factoryParam<_i58.VoiceActorContentsPagingBloc, String, _i59.MediaSort>((
      staffId,
      mediaSort,
    ) =>
        _i58.VoiceActorContentsPagingBloc(
          staffId,
          gh<_i36.MediaInformationRepository>(),
          mediaSort,
        ));
    gh.factoryParam<_i60.WatchingAnimeListPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i60.WatchingAnimeListPagingBloc(
          userId,
          gh<_i37.MediaListRepository>(),
          perPageCount,
        ));
    gh.lazySingleton<_i61.ActivityRepository>(() => _i61.ActivityRepository(
          gh<_i24.ActivityDao>(),
          gh<_i26.AniListDataSource>(),
          gh<_i20.UserDataPreferences>(),
        ));
    gh.factoryParam<_i62.ActivityStatusBloc, String, dynamic>((
      activityId,
      _,
    ) =>
        _i62.ActivityStatusBloc(
          gh<_i61.ActivityRepository>(),
          gh<_i13.MessageRepository>(),
          activityId,
        ));
    gh.factoryParam<_i63.AiringScheduleOfDayBloc, DateTime, dynamic>((
      _dateTime,
      _,
    ) =>
        _i63.AiringScheduleOfDayBloc(
          _dateTime,
          gh<_i36.MediaInformationRepository>(),
          gh<_i13.MessageRepository>(),
        ));
    gh.factoryParam<_i64.AnimePageBloc, _i65.MediaCategory, dynamic>((
      category,
      _,
    ) =>
        _i64.AnimePageBloc(
    ...
    gh.factory<_i67.BirthdayCharacterPageBloc>(
        () => _i67.BirthdayCharacterPageBloc(gh<_i32.CharacterRepository>()));
    gh.factory<_i68.BirthdayCharactersBloc>(
        () => _i68.BirthdayCharactersBloc(gh<_i32.CharacterRepository>()));
    gh.factoryParam<_i69.CharacterPagingBloc, String, _i70.StaffLanguage>((
      animeId,
      staffLanguage,
    ) =>
        _i69.CharacterPagingBloc(
          animeId,
          staffLanguage,
          gh<_i36.MediaInformationRepository>(),
        ));
    gh.factoryParam<_i71.CharacterSearchResultPagingBloc, String, dynamic>((
      _searchString,
      _,
    ) =>
        _i71.CharacterSearchResultPagingBloc(
          _searchString,
          gh<_i48.SearchRepository>(),
        ));
    gh.factoryParam<_i60.CompleteAnimeListPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i60.CompleteAnimeListPagingBloc(
          userId,
          gh<_i37.MediaListRepository>(),
          perPageCount,
        ));
    gh.factoryParam<_i72.DetailCharacterBloc, String, dynamic>((
      _characterId,
      _,
    ) =>
        _i72.DetailCharacterBloc(
          _characterId,
          gh<_i36.MediaInformationRepository>(),
          gh<_i13.MessageRepository>(),
          gh<_i34.FavoriteRepository>(),
    ...
    gh.factoryParam<_i73.DetailMediaBloc, String, dynamic>((
      mediaId,
      _,
    ) =>
        _i73.DetailMediaBloc(
          mediaId,
          gh<_i29.AuthRepository>(),
          gh<_i34.FavoriteRepository>(),
          gh<_i21.UserDataRepository>(),
    ...
    gh.factoryParam<_i74.DetailStaffBloc, String, dynamic>((
      staffId,
      _,
    ) =>
        _i74.DetailStaffBloc(
          staffId,
          gh<_i36.MediaInformationRepository>(),
          gh<_i13.MessageRepository>(),
          gh<_i34.FavoriteRepository>(),
    ...
    gh.factoryParam<_i75.DetailStudioBloc, String, dynamic>((
      studioId,
      _,
    ) =>
        _i75.DetailStudioBloc(
          studioId,
          gh<_i36.MediaInformationRepository>(),
          gh<_i34.FavoriteRepository>(),
          gh<_i21.UserDataRepository>(),
    ...
    gh.factoryParam<_i60.DroppedAnimeListPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i60.DroppedAnimeListPagingBloc(
          userId,
          gh<_i37.MediaListRepository>(),
          perPageCount,
        ));
    gh.factoryParam<_i45.DroppedMangaListPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i45.DroppedMangaListPagingBloc(
          userId,
          gh<_i37.MediaListRepository>(),
          perPageCount,
        ));
    gh.factoryParam<_i77.FavoriteAnimePagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i77.FavoriteAnimePagingBloc(
          userId,
          perPageCount,
          gh<_i34.FavoriteRepository>(),
        ));
    gh.factoryParam<_i78.FavoriteCharacterPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i78.FavoriteCharacterPagingBloc(
          userId,
          gh<_i34.FavoriteRepository>(),
          gh<_i21.UserDataRepository>(),
          perPageCount,
        ));
    gh.factoryParam<_i79.FavoriteMangaPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i79.FavoriteMangaPagingBloc(
          userId,
          gh<_i34.FavoriteRepository>(),
          perPageCount,
        ));
    gh.factoryParam<_i80.MediaCategoryPreviewBloc,
        _i80.MediaCategoryPreviewParams, dynamic>((
      _params,
      _,
    ) =>
        _i80.MediaCategoryPreviewBloc(
          _params,
          gh<_i36.MediaInformationRepository>(),
          gh<_i37.MediaListRepository>(),
        ));
    gh.factoryParam<_i81.MediaSearchResultPagingBloc, _i41.MediaType, String>((
      _mediaType,
      _searchString,
    ) =>
        _i81.MediaSearchResultPagingBloc(
          _mediaType,
          _searchString,
          gh<_i48.SearchRepository>(),
        ));
    gh.factoryParam<_i82.NotificationPagingBloc, _i42.NotificationCategory,
        dynamic>((
      _category,
      _,
    ) =>
        _i82.NotificationPagingBloc(
          gh<_i42.NotificationRepository>(),
          _category,
        ));
    gh.factoryParam<_i83.StatsBloc, String, dynamic>((
      userId,
      _,
    ) =>
        _i83.StatsBloc(
          gh<_i57.UserStatisticsRepository>(),
          gh<_i13.MessageRepository>(),
          gh<_i21.UserDataRepository>(),
          userId,
        ));
    gh.factoryParam<_i84.UserActivityPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i84.UserActivityPagingBloc(
          userId,
          gh<_i61.ActivityRepository>(),
          gh<_i21.UserDataRepository>(),
          perPageCount,
        ));
    gh.factory<_i85.ActivityBloc>(
        () => _i85.ActivityBloc(gh<_i61.ActivityRepository>()));
    ...
    gh.factoryParam<_i89.ActivityRepliesBloc, String, dynamic>((
      activityId,
      _,
    ) =>
        _i89.ActivityRepliesBloc(
          gh<_i61.ActivityRepository>(),
          gh<_i13.MessageRepository>(),
          activityId,
        ));
...
class _$DIDataBaseModule extends _i90.DIDataBaseModule {}

class _$DINetworkModule extends _i27.DINetworkModule {}

class _$DIFirebaseRemoteConfigModule
    extends _i91.DIFirebaseRemoteConfigModule {}
