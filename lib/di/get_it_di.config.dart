...
import 'package:aniflow/core/common/definitions/activity_scope_category.dart'
    as _i72;
import 'package:aniflow/core/common/definitions/anime_category.dart' as _i52;
import 'package:aniflow/core/common/definitions/media_sort.dart' as _i46;
import 'package:aniflow/core/common/definitions/media_type.dart' as _i66;
import 'package:aniflow/core/common/definitions/staff_language.dart' as _i55;
...
import 'package:aniflow/core/data/notification_repository.dart' as _i32;
...
import 'package:aniflow/core/data/user_statistics_repository.dart' as _i44;
...
import 'package:aniflow/core/database/di/database_module.dart' as _i75;
...
import 'package:aniflow/feature/airing_schedule/bloc/airing_schedule_bloc.dart'
    as _i50;
import 'package:aniflow/feature/auth/bloc/auth_bloc.dart' as _i53;
...
import 'package:aniflow/feature/detail_studio/bloc/studio_contents_paging_bloc.dart'
    as _i40;
import 'package:aniflow/feature/discover/bloc/discover_bloc.dart' as _i61;
...
import 'package:aniflow/feature/media_track/bloc/track_bloc.dart' as _i42;
...
import 'package:aniflow/feature/notification/bloc/notification_paging_bloc.dart'
    as _i67;
import 'package:aniflow/feature/profile/profile_bloc.dart' as _i33;
...
import 'package:aniflow/feature/profile/sub_media_list/bloc/manga_list_paging_bloc.dart'
    as _i34;
import 'package:aniflow/feature/profile/sub_stats/bloc/stats_bloc.dart' as _i68;
import 'package:aniflow/feature/search/bloc/search_bloc.dart' as _i35;
...
import 'package:aniflow/feature/search/paging/user_search_result_paging_bloc.dart'
    as _i43;
import 'package:aniflow/feature/settings/bloc/settings_bloc.dart' as _i37;
...
import 'package:aniflow/feature/social/activity_replies/bloc/activity_replies_bloc.dart'
    as _i74;
import 'package:aniflow/feature/staff_page/bloc/staff_page_bloc.dart' as _i38;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i32.NotificationRepository>(
        () => _i32.NotificationRepository(
              gh<_i24.AuthDataSource>(),
              gh<_i16.UserDao>(),
              gh<_i10.MediaDao>(),
            ));
    gh.factoryParam<_i33.ProfileBloc, String?, dynamic>((
      _userId,
      _,
    ) =>
        _i33.ProfileBloc(
    ...
    gh.factoryParam<_i34.ReadingMangaListPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i34.ReadingMangaListPagingBloc(
          userId,
          gh<_i31.MediaListRepository>(),
          perPageCount,
        ));
    gh.factory<_i35.SearchBloc>(
        () => _i35.SearchBloc(gh<_i18.UserDataRepository>()));
    ...
    gh.factoryParam<_i38.StaffPageBloc, String, dynamic>((
      animeId,
      _,
    ) =>
        _i38.StaffPageBloc(
    ...
    gh.factoryParam<_i39.StaffSearchResultPagingBloc, String, dynamic>((
      _searchString,
      _,
    ) =>
        _i39.StaffSearchResultPagingBloc(
          _searchString,
          gh<_i36.SearchRepository>(),
        ));
    gh.factoryParam<_i40.StudioContentsPagingBloc, String, dynamic>((
      studioId,
      _,
    ) =>
        _i40.StudioContentsPagingBloc(
          studioId,
          gh<_i30.MediaInformationRepository>(),
        ));
    gh.factoryParam<_i41.StudioSearchResultPagingBloc, String, dynamic>((
      _searchString,
      _,
    ) =>
        _i41.StudioSearchResultPagingBloc(
          _searchString,
          gh<_i36.SearchRepository>(),
        ));
    gh.factory<_i42.TrackBloc>(() => _i42.TrackBloc(
          gh<_i31.MediaListRepository>(),
          gh<_i25.AuthRepository>(),
          gh<_i18.UserDataRepository>(),
        ));
    gh.factoryParam<_i43.UserSearchResultPagingBloc, String, dynamic>((
      _searchString,
      _,
    ) =>
        _i43.UserSearchResultPagingBloc(
          _searchString,
          gh<_i36.SearchRepository>(),
        ));
    gh.lazySingleton<_i44.UserStatisticsRepository>(
        () => _i44.UserStatisticsRepository(
              gh<_i10.MediaDao>(),
              gh<_i22.AniListDataSource>(),
            ));
    gh.factoryParam<_i45.VoiceActorContentsPagingBloc, String, _i46.MediaSort>((
      staffId,
      mediaSort,
    ) =>
        _i45.VoiceActorContentsPagingBloc(
          staffId,
          gh<_i30.MediaInformationRepository>(),
          mediaSort,
        ));
    gh.factoryParam<_i47.WatchingAnimeListPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i47.WatchingAnimeListPagingBloc(
          userId,
          gh<_i31.MediaListRepository>(),
          perPageCount,
        ));
    ...
    gh.factoryParam<_i49.ActivityStatusBloc, String, dynamic>((
      activityId,
      _,
    ) =>
        _i49.ActivityStatusBloc(
          gh<_i48.ActivityRepository>(),
          activityId,
        ));
    gh.factory<_i50.AiringScheduleBloc>(() => _i50.AiringScheduleBloc(
          gh<_i30.MediaInformationRepository>(),
          gh<_i18.UserDataRepository>(),
        ));
    ...
    gh.factory<_i53.AuthBloc>(() => _i53.AuthBloc(gh<_i25.AuthRepository>()));
    gh.factoryParam<_i54.CharacterPagingBloc, String, _i55.StaffLanguage>((
      animeId,
      staffLanguage,
    ) =>
        _i54.CharacterPagingBloc(
          animeId,
          staffLanguage,
          gh<_i30.MediaInformationRepository>(),
        ));
    gh.factoryParam<_i56.CharacterSearchResultPagingBloc, String, dynamic>((
      _searchString,
      _,
    ) =>
        _i56.CharacterSearchResultPagingBloc(
          _searchString,
          gh<_i36.SearchRepository>(),
        ));
    gh.factoryParam<_i47.CompleteAnimeListPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i47.CompleteAnimeListPagingBloc(
          userId,
          gh<_i31.MediaListRepository>(),
          perPageCount,
        ));
    gh.factoryParam<_i57.DetailCharacterBloc, String, dynamic>((
      _characterId,
      _,
    ) =>
        _i57.DetailCharacterBloc(
          _characterId,
          gh<_i30.MediaInformationRepository>(),
          gh<_i28.FavoriteRepository>(),
          gh<_i18.UserDataRepository>(),
        ));
    gh.factoryParam<_i58.DetailMediaBloc, String, dynamic>((
      mediaId,
      _,
    ) =>
        _i58.DetailMediaBloc(
          mediaId,
          gh<_i25.AuthRepository>(),
          gh<_i28.FavoriteRepository>(),
          gh<_i18.UserDataRepository>(),
    ...
    gh.factoryParam<_i59.DetailStaffBloc, String, dynamic>((
      staffId,
      _,
    ) =>
        _i59.DetailStaffBloc(
          staffId,
          gh<_i30.MediaInformationRepository>(),
          gh<_i28.FavoriteRepository>(),
          gh<_i18.UserDataRepository>(),
        ));
    gh.factoryParam<_i60.DetailStudioBloc, String, dynamic>((
      studioId,
      _,
    ) =>
        _i60.DetailStudioBloc(
          studioId,
          gh<_i30.MediaInformationRepository>(),
          gh<_i28.FavoriteRepository>(),
          gh<_i18.UserDataRepository>(),
        ));
    gh.factory<_i61.DiscoverBloc>(() => _i61.DiscoverBloc(
          gh<_i25.AuthRepository>(),
          gh<_i30.MediaInformationRepository>(),
          gh<_i31.MediaListRepository>(),
          gh<_i18.UserDataRepository>(),
        ));
    gh.factoryParam<_i47.DroppedAnimeListPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i47.DroppedAnimeListPagingBloc(
          userId,
          gh<_i31.MediaListRepository>(),
          perPageCount,
        ));
    gh.factoryParam<_i34.DroppedMangaListPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i34.DroppedMangaListPagingBloc(
          userId,
          gh<_i31.MediaListRepository>(),
          perPageCount,
        ));
    gh.factoryParam<_i62.FavoriteAnimePagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i62.FavoriteAnimePagingBloc(
          userId,
          perPageCount,
          gh<_i28.FavoriteRepository>(),
        ));
    gh.factoryParam<_i63.FavoriteCharacterPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i63.FavoriteCharacterPagingBloc(
          userId,
          gh<_i28.FavoriteRepository>(),
          gh<_i18.UserDataRepository>(),
          perPageCount,
        ));
    gh.factoryParam<_i64.FavoriteMangaPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i64.FavoriteMangaPagingBloc(
          userId,
          gh<_i28.FavoriteRepository>(),
          perPageCount,
        ));
    gh.factoryParam<_i65.MediaSearchResultPagingBloc, _i66.MediaType, String>((
      _mediaType,
      _searchString,
    ) =>
        _i65.MediaSearchResultPagingBloc(
          _mediaType,
          _searchString,
          gh<_i36.SearchRepository>(),
        ));
    gh.factoryParam<_i67.NotificationPagingBloc, _i32.NotificationCategory,
        dynamic>((
      _category,
      _,
    ) =>
        _i67.NotificationPagingBloc(
          gh<_i32.NotificationRepository>(),
          _category,
        ));
    gh.factoryParam<_i68.StatsBloc, String, dynamic>((
      userId,
      _,
    ) =>
        _i68.StatsBloc(
          gh<_i44.UserStatisticsRepository>(),
          gh<_i18.UserDataRepository>(),
          userId,
        ));
    gh.factoryParam<_i69.UserActivityPagingBloc, String, int>((
      userId,
      perPageCount,
    ) =>
        _i69.UserActivityPagingBloc(
          userId,
          gh<_i48.ActivityRepository>(),
          gh<_i18.UserDataRepository>(),
          perPageCount,
        ));
    gh.factory<_i70.ActivityBloc>(
        () => _i70.ActivityBloc(gh<_i48.ActivityRepository>()));
    gh.factoryParam<_i71.ActivityPagingBloc, _i72.ActivityScopeCategory,
        _i73.ActivityFilterType>((
      userType,
      filterType,
    ) =>
        _i71.ActivityPagingBloc(
          gh<_i48.ActivityRepository>(),
          gh<_i18.UserDataRepository>(),
          userType,
          filterType,
        ));
    gh.factoryParam<_i74.ActivityRepliesBloc, String, dynamic>((
      activityId,
      _,
    ) =>
        _i74.ActivityRepliesBloc(
          gh<_i48.ActivityRepository>(),
          activityId,
        ));
    return this;
...
class _$DIDataBaseModule extends _i75.DIDataBaseModule {}
