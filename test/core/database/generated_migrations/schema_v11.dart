...
class MediaAiringScheduleUpdatedTable extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  MediaAiringScheduleUpdatedTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  MediaAiringScheduleUpdatedTable createAlias(String alias) {
    return MediaAiringScheduleUpdatedTable(attachedDatabase, alias);
  }
}

class SearchResultTable extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SearchResultTable(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> mediaId = GeneratedColumn<String>(
  ...
  @override
  SearchResultTable createAlias(String alias) {
    return SearchResultTable(attachedDatabase, alias);
  }
}
...
class DatabaseAtV11 extends GeneratedDatabase {
  ...
  late final MediaAiringScheduleUpdatedTable mediaAiringScheduleUpdatedTable =
      MediaAiringScheduleUpdatedTable(this);
  late final SearchResultTable searchResultTable = SearchResultTable(this);
  @override
